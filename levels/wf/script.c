...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, 324, 1409, -2558, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -402, 1409, -2558, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -2071, 1778, -1572, 0, -180, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -2058, 2045, 70, 0, 90, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -1377, 1426, -2592, 0, -90, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_NEW_THWOMP, 3258, 1482, -3363, 0, -90, 0, 0x00000000, bhvSidewaysThwomp),
		OBJECT(MODEL_NEW_THWOMP, 4396, 1482, -3363, 0, -90, 0, 0x00000000, bhvSidewaysThwomp),
		OBJECT(MODEL_NEW_THWOMP, 2947, 1905, 999, 0, -90, 0, (0x01 << 24), bhvSidewaysThwomp),
		OBJECT(MODEL_NEW_THWOMP, 3823, 1905, 72, 0, -90, 0, 0x00000000, bhvSidewaysThwomp),
		...
		OBJECT(MODEL_THWIMP, -1912, 832, -674, 0, 0, 0, (0x0A << 16) | (1 << 8), bhvThwimp),
		...
		OBJECT(MODEL_NEW_THWOMP, 324, 968, -2558, 0, 90, 0, 0x00000000, bhvNewThwomp),
		OBJECT(MODEL_THWOMP, 5643, 1610, -2151, 0, 0, 0, 0x00000000, bhvThwomp),
		OBJECT(MODEL_NEW_THWOMP, -402, 968, -2558, 0, 90, 0, 0x00000000, bhvNewThwomp),
		OBJECT(MODEL_NEW_THWOMP, -2071, 1337, -1572, 0, -180, 0, 0x00000000, bhvNewThwomp),
		OBJECT(MODEL_NEW_THWOMP, -1377, 986, -2592, 0, 90, 0, 0x00000000, bhvNewThwomp),
		OBJECT(MODEL_NEW_THWOMP, -2058, 1605, 70, 0, -180, 0, 0x00000000, bhvNewThwomp),
