...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_DL_CANNON_LID, -1199, 2155, 2480, 0, 0, 0, (40 << 16), bhvCannonClosed),
		...
		OBJECT(MODEL_THWOMP, 3827, 2414, 1408, 0, 0, 0, 0x00000000, bhvSidewaysThwomp),
		OBJECT(MODEL_THWOMP, 3827, 2414, 2545, 0, 0, 0, 0x00000000, bhvSidewaysThwomp),
